...
public class ListCommandsCommandHandler extends CommandHandler {
  ...
  private static final List<String> MANUAL = List.of(
      ...
      "Examples:",
      "- &b/infiniplots commands&r : Display the 1st page of commands",
      "- &b/infiniplots commands 2&r : Display the 2nd page of commands"
  );

  private final CommandDelegator delegator;

  public ListCommandsCommandHandler(CommandDelegator delegator) {
  ...
  public void execute(CommandContext context) throws InterruptCommandException {
    ...
    if (context.args().isEmpty() && totalPages > 1) {
      message.add("Type &b/infiniplots commands 2&r to see more commands".formatted(context.label()));
    }
